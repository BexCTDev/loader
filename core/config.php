...
$config['path']['apache_root'] = substr($config['path']['htdocs_root'] , 0, strrpos($config['path']['htdocs_root'], '/htdocs' ) + 1) . 'apache/';
$config['path']['mysql_root'] = substr($config['path']['htdocs_root'] , 0, strrpos($config['path']['htdocs_root'], '/htdocs' ) + 1) . 'mysql/';


$config['path']['apache_conf'] = $config['path']['apache_root'] . 'conf/confd/';
$config['path']['apache_logs'] = $config['path']['apache_root'] . 'logs/';

$config['loader']['root'] = substr($config['path']['htdocs_root'] , 0, strrpos($config['path']['htdocs_root'], '/public' ) + 1);
